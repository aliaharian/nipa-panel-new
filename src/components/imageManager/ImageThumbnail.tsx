  ...
  return (
    <div className="group/item w-full h-full rounded-[6px] overflow-hidden relative">
      <div className="w-full h-full relative">
        ...
        />
        {/* //overlay */}
        <div className="absolute top-0 left-0 bg-black-60 w-full h-full flex grid grid-rows-3 opacity-0 pointer-events-none group-hover/item:opacity-100 group-hover/item:pointer-events-auto transition-all">
          <div></div>
          <div>
            {handleViewImage && (
              <p
